...
class WooThemes_Sensei_Certificates {
	...
	public function __construct( $file ) {
		...
		add_filter( 'sensei_certificates_data_field_value', array( $this, 'replace_data_field_template_tags'), 10, 5 );
	...
	public function certificate_text( $pdf_certificate, $fpdf ) {
		...
		if ( 0 < intval( $certificate_id ) ) {
			...
			foreach ( $data_fields as $field_key => $field_info ) {
				...
				$field_value = apply_filters( 'sensei_certificates_data_field_value', $field_value, $field_key, false, $student, $course );
